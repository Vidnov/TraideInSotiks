...
public class CheckTestVibrateActivity extends AppCompatActivity {
   ...
   private int Count2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_test_vibrate);
        ...
        String CountVibrations =intent.getStringExtra("COUNT");
        Count = Integer.parseInt (CountVibrations)+1;
        Count2=Integer.parseInt (CountVibrations);
    }
        ...
        if(Count==Count2){
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                     try {
                            ...
                            Intent Menu = new Intent(CheckTestVibrateActivity.this,MainActivity.class);
                            startActivity(Menu);
            ...
            retry.setOnClickListener(new View.OnClickListener() {
                 ...
                 public void onClick(View v) {
                     Intent TestVibration = new Intent(CheckTestVibrateActivity.this,CheckTestVibrateActivity.class);
